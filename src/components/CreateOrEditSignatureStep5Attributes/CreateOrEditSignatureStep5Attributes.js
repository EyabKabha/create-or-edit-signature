      ...
      <div>
        <div className="container ml-2 mt-2">
          <div className="row">
            ...
            <div className="col">
              <select className="custom-select my-1 mr-sm-2" id="Left">
          ...
          <div className="row">
            ...
            <div className="col">
              <select className="custom-select my-1 mr-sm-2" id="Right">
                <option selected>0</option>
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
        ...
        <div className="row ml-2">
          <div className="col-md-4 mb-4 col-sm-3 col-4">
            <button className="btn btn-secondary ml-4 mt-4">previous</button>
          </div>
          <div class="col-md-4 col-sm-3 mb-4 col-6">
            <button class="btn btn-secondary ml-4 mt-4">Add new Signature</button>
          </div>
        </div>
      </div>
    );
